...
const Hero1 = () => {
  const text = "Building innovative and scalable web applications with cutting-edge technologies to solve real-world problems.".split(" ");
  const text2 = "Experienced Full Stack Developer with expertise in modern web technologies and a passion for clean, efficient code.".split(" ");

  const handleDownload = () => {
    const resumeUrl = "/JISHNU_2025.pdf";
    const link = document.createElement("a");
    link.href = resumeUrl;
    link.setAttribute("download", "Jishnu_TP_Resume.pdf");
    ...
    <section className="relative flex flex-col md:flex-row items-center justify-between px-8 lg:px-40 py-20 min-h-fit bg-gray-900 text-white" id="about">
      ...
      <div className="relative flex flex-col items-center md:items-start text-center md:text-left space-y-6 md:w-1/2">
        ...
        <div className="flex space-x-6 lg:ml-16">
          ...
          <motion.a
            href="mailto:tpjishnu5@gmail.com"
            target="_blank"
            rel="noopener noreferrer"
            whileHover={{ scale: 1.2 }}
            className="p-2 rounded-full bg-white/10 hover:bg-white/20 transition"
      ...
      <div className="md:w-1/2 mt-10 md:mt-0">
        <motion.h1
          ...
          transition={{ duration: 0.8, ease: "easeOut" }}
        >
          Hi, I'm <span className="text-blue-500">Jishnu</span>
        </motion.h1>
