  ...
  return (
    <section className="w-full min-h-screen py-16 px-6 sm:px-10 lg:px-20 bg-gray-900 text-white flex flex-col items-center" id="contact">
      ...
      <div className="mt-8 text-center">
        ...
        <a href="mailto:tpjishnu5@gmail.com" className="text-purple-400 hover:text-purple-300 transition-colors flex items-center justify-center space-x-1">
          <span>tpjishnu5@gmail.com</span> <FaEnvelope className="ml-1" />
        </a>
      </div>
    </section>
  );
