        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-12 lg:px-36">
          ...
          <div className={`transition-transform duration-1000 ${show ? "translate-x-0 opacity-100" : "-translate-x-10 opacity-0"}`}>
            ...
            <div className="border-l-2 border-gray-700">
              {[
                { period: "2025-sept– present", role: "Software Engineer", company: "Trimah-Technologies - (remote)" },
                ...
                <div key={index} className="ml-4 mb-6 p-4 transition-all bg-white/10 backdrop-blur-md border-l-4 border-transparent hover:border-blue-500 hover:scale-105 rounded-lg shadow-lg">
